...
#define ABOUT_HITS_MOVEMENT_UP_DOWN "THE MOVEMENT IS DONE ON THE DOWN AND UP ARROWS FOR SELECTION,"
#define ABOUT_HITS_MOVEMENT_RIGHT_LEFT "THE RIGHT AND LEFT ARROWS ARE USED TO MOVE THE CUSSOR IN THE WINDOWS WHERE THE INPUT TAKES PLACE"
